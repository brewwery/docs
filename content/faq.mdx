...
Not yet — v0.9.2 is still pre-v1.0. Unsigned builds may trigger macOS Gatekeeper warnings. Right-click the app and select Open to bypass. Signing is planned for v1.0.
